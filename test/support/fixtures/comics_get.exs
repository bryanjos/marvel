%{
  ...
  "data" => %{
    ...
    "results" => [
      %{
        ...
        "dates" => [
          %{"date" => "2099-10-30T00:00:00-0500", "type" => "onsaleDate"},
        ...
        "pageCount" => 112,
        "prices" => [%{"price" => 0, "type" => "printPrice"}],
        ...
        "urls" => [
          %{
            "type" => "detail",
            "url" =>
              "http://marvel.com/comics/issue/82967/marvel_previews_2017?utm_campaign=apiRef&utm_source=b3e5c564c107530c1520fb3d8372f802"
          }
        ],
        "variantDescription" => "",
        "variants" => [
  ...
  "etag" => "067d619d9e950386739a2537ecb4a2fc89e9d30e",
  "status" => "Ok"
}
