%{
      ...
      %{
        ...
        "urls" => [
          %{
            "type" => "detail",
            "url" =>
              "http://marvel.com/comics/series/31445/_fantastic_four_by_dan_slott_vol_1_2021?utm_campaign=apiRef&utm_source=b3e5c564c107530c1520fb3d8372f802"
          }
        ]
      }
    ],
  ...
  "etag" => "f5105178ce9c894b6fbdc336981f0ce0763a1822",
  "status" => "Ok"
}
