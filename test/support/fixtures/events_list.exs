%{
      ...
      %{
        ...
        "urls" => [
          %{
            "type" => "detail",
            "url" =>
              "http://marvel.com/comics/events/116/acts_of_vengeance?utm_campaign=apiRef&utm_source=b3e5c564c107530c1520fb3d8372f802"
          },
          %{
            "type" => "wiki",
            "url" =>
              "http://marvel.com/universe/Acts_of_Vengeance!?utm_campaign=apiRef&utm_source=b3e5c564c107530c1520fb3d8372f802"
          }
        ]
      }
    ],
  ...
  "etag" => "96fecbdae89d5dff2c7afb35b98cac4c2fa18646",
  "status" => "Ok"
}
